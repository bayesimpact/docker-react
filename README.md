...
Do not use this image for production, you should compile your React anyway and only push the result of dist.
...
Use it as a base and mount or copy your actual application in `/usr/app`.
